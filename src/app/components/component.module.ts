...
@NgModule({
  declarations: [ButtonComponent, SelectComponent, ImageComponent],
  imports: [CommonModule],
  exports: [ButtonComponent, SelectComponent, ImageComponent], // componenti moduleden dışarı çıkartır.
})
